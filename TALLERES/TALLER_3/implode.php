...
$paises = ["PANAMA","BOLIVIA","COLOMBIA","VENEZUELA","ARGENTINA"]; // Reemplaza esto con tu array de países
$listaPaises = implode("-", $paises);

echo "Mi lista de países para visitar: $listaPaises <br>";
...
echo "Información de la persona: $infoPersona <br>";
?>