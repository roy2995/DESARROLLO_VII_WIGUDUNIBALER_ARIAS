...
$misAmigos = ["JONATHAN","LUIS", "JORGE"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "ANGUIEL", "CRISTINE"); // Reemplaza las comillas vacías con los nombres de tus amigos
